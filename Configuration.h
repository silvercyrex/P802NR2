...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ZRIB_V20//BOARD_RAMPS_14_EFB
#endif
 ...
 *  5001 : 100k thermistor - custom for my printers Tool 0
 *  5002 : 100k thermistor - custom for my printers Tool 1
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 200, 200, 50, 50 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1250, 1250, 1250, 5000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013 //0.026 // (mm) Distance from real junction edge
#endif
 ...
 *
 */
#define Z_MIN_PROBE_PIN Z_MAX_PIN //Pin 19 // Pin 32 is the RAMPS default
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 48, 14, -2.4 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define MIN_PROBE_EDGE 5

// X and Y axis travel speed (mm/m) between probesF
...
#define Z_CLEARANCE_BETWEEN_PROBES  11 // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     11 // Z Clearance between multiple probes
